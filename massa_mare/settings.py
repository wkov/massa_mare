"""
Django settings for massa_mare project.
...
SECRET_KEY = 'v$jsx07l6w!)sv9a39%#(wvx0q*3l5av_a-#3fem#2j2#ebycn'
...
ROOT_URLCONF = 'massa_mare.urls'

WSGI_APPLICATION = 'massa_mare.wsgi.application'
